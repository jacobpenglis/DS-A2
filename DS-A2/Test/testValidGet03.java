...
// Unit Test: Multiple GET Requests maintainging correct lamport

public class testValidGet03 {
    ...
    public void testValidGetRequest() throws IOException {
        ...
        String[] args3 = {"http://localhost:4567"};
        GETClient.main(args3);
        assertTrue(outContent.toString().contains("ID8374849"));
        assertTrue(outContent.toString().contains("Lamport-Clock:4"));
    }
}
