...
// Unit Test: Testing that invalid data will throw an IOException and send a '204' 

public class testInvalidPut01 {
    ...
    public void testInvalidPut() throws IOException {
        ...
        Exception exception = assertThrows(IOException.class, () -> {
            String[] args = {"http://localhost:4567", "./data/invalid_data.txt"};
